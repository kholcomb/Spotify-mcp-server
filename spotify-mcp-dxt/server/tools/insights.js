 ...
 */
export class GetUserTopTracksTool {
    spotifyClient;
    name = 'get_user_top_tracks';
    description = 'Get user\'s top tracks based on listening history';
    ...
    async execute(input) {
        try {
            ...
            if (params.time_range)
                options.time_range = params.time_range;
            if (params.limit)
 ...
 */
export class GetUserTopArtistsTool {
    spotifyClient;
    name = 'get_user_top_artists';
    description = 'Get user\'s top artists based on listening history';
    inputSchema = z.object({
        time_range: z.enum(['short_term', 'medium_term', 'long_term']).optional()
            .describe('Time range: short_term (~4 weeks), medium_term (~6 months), long_term (~1 year)'),
        limit: z.number().min(1).max(50).optional().describe('Number of results (1-50, default 20)'),
 ...
 */
export class GetAudioFeaturesTool {
    spotifyClient;
    name = 'get_audio_features';
    description = 'Get detailed audio features and analysis for a track';
    inputSchema = z.object({
 ...
 */
export class GetUserSavedTracksTool {
    spotifyClient;
    name = 'get_user_saved_tracks';
    description = 'Get tracks saved in user\'s library (liked songs)';
    inputSchema = z.object({
        limit: z.number().min(1).max(50).optional().describe('Number of results (1-50, default 20)'),
        offset: z.number().min(0).optional().describe('Offset for pagination (default 0)'),
 ...
 */
export class GetUserSavedAlbumsTool {
    spotifyClient;
    name = 'get_user_saved_albums';
    description = 'Get albums saved in user\'s library';
    inputSchema = z.object({
        limit: z.number().min(1).max(50).optional().describe('Number of results (1-50, default 20)'),
        offset: z.number().min(0).optional().describe('Offset for pagination (default 0)'),
 ...
 */
export class GetUserFollowedArtistsTool {
    spotifyClient;
    name = 'get_user_followed_artists';
 ...
 */
export function createInsightsTools(spotifyClient) {
    return [
