 ...
 */
export class GetPlaybackStatusTool {
    spotifyClient;
    ...
    async execute(input) {
        try {
            ...
            if (params.additionalTypes)
                options.additional_types = params.additionalTypes.join(',');
 ...
 */
export class GetAuthStatusTool {
    authService;
 ...
 */
export function createStatusTools(spotifyClient, authService) {
    return [
