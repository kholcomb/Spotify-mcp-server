...
import { createPlaybackTools, createSearchTools, createQueueTools, createStatusTools, createInsightsTools, } from '../tools/index.js';
/**
...
export class MCPServer {
    ...
    constructor(config, logger) {
        ...
        this.requestHandler = new RequestHandler(this.toolRegistry, this.authService, logger);
